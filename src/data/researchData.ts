...
export const haats: Haat[] = [
  ...
  },
  {
    ...
    block: "Makdi",
    marketDay: "Thursday",
    villages: "Bhandarseoni, Charkai, Diganar, Fupgaon, Gumdi",
    products: " char, vegetables",
    sellers: 110,
    buyers: 520,
...
export const fieldRows: FieldRow[] = [
  ...
  { id: "R-005", date: "11-Apr-2026", haat: "Lanjoda", village: "Bhanpuri", type: "Seller", gender: "Male", category: "NTFP", product: "Char (chironji)", source: "Forest", qty: "5 kg", price: "320/kg", dailySale: 1600, profit: 1300, transport: 120, buyerType: "Trader", problems: "Price volatility", circular: "Cloth bag", suggestion: "Price display board", photo: "Pending", quote: "Char prices change every week." },
  { id: "R-006", date: "11-Apr-2026", haat: "Lanjoda", village: "Makdi", type: "Buyer", gender: "Female", category: "Vegetables", product: "Mixed", source: "—", qty: "—", price: "—", dailySale: 0, profit: 0, transport: 20, buyerType: "—", problems: "Weighing disputes", circular: "—", suggestion: "Verified scales", photo: "Pending", quote: "Sometimes the scale is not fair." },
